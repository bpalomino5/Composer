      ...
      if (test.length() > 0) {
        ...
        for (int y = 0; y < blocks.length; y++) {
          ...
          if(blocks[y].length()>1){
            ...
            //only a-z, A-Z, are allowed as first letters, 39 = '' cause i couldnt split it and not loose the letter
            if ((sort > 64 && sort < 91) || (sort > 96 && sort < 123) || sort == 39) {
              if(sort == 39){
                count++;
              }
              ...
              while (((sort > 64 && sort < 91) || (sort > 96 && sort < 123) || sort == 95 || (sort > 47 && sort < 58)) && count < blocks[y].length()) {
                word += blocks[y].charAt(count);
                count++;
              }
